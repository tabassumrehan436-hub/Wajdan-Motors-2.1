...
export default function Footer() {
  ...
  const phoneHref = `tel:${(settings.phone || '+92-313-4959787').replace(/\D/g, '')}`;
  const waHref = settings.whatsappNumber ? `https://wa.me/${settings.whatsappNumber}` : 'https://wa.me/923134959787';
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-12 sm:mb-16 gap-6 sm:gap-0">
          ...
          <div className="flex justify-center items-center gap-6 sm:gap-7 md:gap-8">
            <a href="https://www.facebook.com/p/Bloodline-Motors-61560849735018/" aria-label="Visit our Facebook page" target="_blank" rel="noopener noreferrer" className="social-icon-enhanced text-white hover:text-white transition-all duration-300 transform hover:scale-110">
              <Facebook className="w-5 h-5 sm:w-6 sm:h-6" />
            </a>
            <a href="https://www.instagram.com/bloodlinemotors/" aria-label="Visit our Instagram profile" target="_blank" rel="noopener noreferrer" className="social-icon-enhanced text-white hover:text-white transition-all duration-300 transform hover:scale-110">
              <Instagram className="w-5 h-5 sm:w-6 sm:h-6" />
            </a>
            <a href="https://www.tiktok.com/@bloodlinemotors" aria-label="Visit our TikTok account" target="_blank" rel="noopener noreferrer" className="social-icon-enhanced text-white hover:text-white transition-all duration-300 transform hover:scale-110">
            ...
            <a href="https://www.youtube.com/channel/UCrmjEzFGcdRbx0GQisTBenQ" aria-label="Visit our YouTube channel" target="_blank" rel="noopener noreferrer" className="social-icon-enhanced text-white hover:text-white transition-all duration-300 transform hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" aria-hidden>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <div className="space-y-1.5 sm:space-y-2 text-white/50 text-xs sm:text-sm">
              ...
              <p>
                <a href="tel:+923134959787" className="text-primary hover:underline">+92-313-4959787 | +92-327-0202782</a>
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="border-t border-white/5 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center text-[11px] sm:text-xs text-white/30 gap-4 sm:gap-0">
          <p>© {new Date().getFullYear()} Bloodline Motors Lahore. All rights reserved.</p>
