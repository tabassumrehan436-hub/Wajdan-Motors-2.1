...
export default function AdminSettings() {
  ...
  const [settings, setSettings] = useState({
    businessName: "Car Club FSD",
    phone: "0325-6750000, +92 325 6750000",
    email: "carclub001@outlook.com",
    address: "VF Centre, Jail Road, Faisalabad",
    whatsappNumber: "923256750000",
  ...
  useEffect(() => {
    try {
      const raw = localStorage.getItem("carclub_fsd_settings");
      if (raw) {
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("carclub_fsd_inquiries");
